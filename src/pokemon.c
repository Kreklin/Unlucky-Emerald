...
void CreateBoxMon(struct BoxPokemon *boxMon, u16 species, u8 level, u8 fixedIV, u8 hasFixedPersonality, u32 fixedPersonality, u8 otIdType, u32 fixedOtId)
{
    ...
    {
        u32 iv;
        // randomly generated iv's are instead zero
        // value = Random();
        value = 0;                      // krek code
...
void CreateMaleMon(struct Pokemon *mon, u16 species, u8 level)
{
    ...
    do
    {
        otId = Random32();
        // personality = Random32();
        personality = HIHALF(otId) ^ LOHALF(otId); // krek code
    }
...
void AdjustFriendship(struct Pokemon *mon, u8 event)
{
    ...
    if (species && species != SPECIES_EGG)
    {
        ...
        // player pokemon never increase in friendship by walking
        // if ((event != FRIENDSHIP_EVENT_WALKING || !(Random() & 1))
        //  && (event != FRIENDSHIP_EVENT_LEAGUE_BATTLE || IS_LEAGUE_BATTLE))
        if (event != FRIENDSHIP_EVENT_LEAGUE_BATTLE || IS_LEAGUE_BATTLE)    // krek code
        {
...
void SetWildMonHeldItem(void)
{
    ...
    {
        // wild pokemon never have held item unless there is a 100% chance
        // u16 rnd = Random() % 100;
        u16 rnd = 0;    // krek code
